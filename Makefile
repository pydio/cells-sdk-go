...
main:
	go build -ldflags "-X github.com/pydio/cells-sdk-go/config.version=0.2 -X github.com/pydio/cells-sdk-go/config.BuildStamp=`date -u +%Y-%m-%dT%H:%M:%S` -X github.com/pydio/cells-sdk-go/config.BuildRevision=`git rev-parse HEAD`" -o cells-sdk-go main.go
