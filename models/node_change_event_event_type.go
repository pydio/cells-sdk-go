...
func (m NodeChangeEventEventType) validateNodeChangeEventEventTypeEnum(path, location string, value NodeChangeEventEventType) error {
	if err := validate.EnumCase(path, location, value, nodeChangeEventEventTypeEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this node change event event type based on context it is used
func (m NodeChangeEventEventType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
