...
// Pointer returns a pointer to a freshly-allocated ActivitySummaryPointOfView.
func (m ActivitySummaryPointOfView) Pointer() *ActivitySummaryPointOfView {
	return &m
}
...
func (m ActivitySummaryPointOfView) validateActivitySummaryPointOfViewEnum(path, location string, value ActivitySummaryPointOfView) error {
	if err := validate.EnumCase(path, location, value, activitySummaryPointOfViewEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this activity summary point of view based on context it is used
func (m ActivitySummaryPointOfView) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
