...
// ContextValidate validates this rest user job request based on context it is used
func (m *RestUserJobRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
