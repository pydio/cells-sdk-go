...
func (m *RestSettingsMenuResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRootMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestSettingsMenuResponse) contextValidateRootMetadata(ctx context.Context, formats strfmt.Registry) error {

	if m.RootMetadata != nil {
		if err := m.RootMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("RootMetadata")
			}
			return err
