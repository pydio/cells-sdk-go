...
func (m *TreeNode) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAppearsIn(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *TreeNode) contextValidateAppearsIn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TreeNode) contextValidateCommits(ctx context.Context, formats strfmt.Registry) error {
