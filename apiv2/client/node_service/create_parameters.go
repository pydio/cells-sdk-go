...
func (o *CreateParams) WithBody(body *models.RestCreateRequest) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.RestCreateRequest) {
	o.Body = body
}
