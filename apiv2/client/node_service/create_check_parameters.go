...
CreateCheckParams contains all the parameters to send to the API endpoint
	...
	for the create check operation.
...
type CreateCheckParams struct {
	...
	*/
	Body *models.RestCreateCheckRequest
...
// WithDefaults hydrates default values in the create check params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateCheckParams) WithDefaults() *CreateCheckParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create check params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateCheckParams) SetDefaults() {
...
func (o *CreateCheckParams) WithBody(body *models.RestCreateCheckRequest) *CreateCheckParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create check params
func (o *CreateCheckParams) SetBody(body *models.RestCreateCheckRequest) {
	o.Body = body
}
