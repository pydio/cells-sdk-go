...
func (o *GetBulkMetaReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /meta/bulk/get] GetBulkMeta", response, response.Code())
	}
}
...
func (o *GetBulkMetaOK) GetPayload() *models2.RestBulkMetaResponse {
	return o.Payload
}
...
func (o *GetBulkMetaUnauthorized) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *GetBulkMetaForbidden) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *GetBulkMetaNotFound) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *GetBulkMetaInternalServerError) GetPayload() *models2.RestError {
	return o.Payload
}
