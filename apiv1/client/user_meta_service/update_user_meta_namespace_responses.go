...
type UpdateUserMetaNamespaceOK struct {
	Payload *models2.IdmUpdateUserMetaNamespaceResponse
}
...
func (o *UpdateUserMetaNamespaceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /user-meta/namespace][%d] updateUserMetaNamespaceOK %s", 200, payload)
}
...
func (o *UpdateUserMetaNamespaceOK) GetPayload() *models2.IdmUpdateUserMetaNamespaceResponse {
	return o.Payload
}
...
func (o *UpdateUserMetaNamespaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.IdmUpdateUserMetaNamespaceResponse)
...
func (o *UpdateUserMetaNamespaceUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /user-meta/namespace][%d] updateUserMetaNamespaceUnauthorized %s", 401, payload)
}
...
func (o *UpdateUserMetaNamespaceUnauthorized) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *UpdateUserMetaNamespaceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /user-meta/namespace][%d] updateUserMetaNamespaceForbidden %s", 403, payload)
}
...
func (o *UpdateUserMetaNamespaceForbidden) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *UpdateUserMetaNamespaceNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /user-meta/namespace][%d] updateUserMetaNamespaceNotFound %s", 404, payload)
}
...
func (o *UpdateUserMetaNamespaceNotFound) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *UpdateUserMetaNamespaceInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /user-meta/namespace][%d] updateUserMetaNamespaceInternalServerError %s", 500, payload)
}
...
func (o *UpdateUserMetaNamespaceInternalServerError) GetPayload() *models2.RestError {
	return o.Payload
}
