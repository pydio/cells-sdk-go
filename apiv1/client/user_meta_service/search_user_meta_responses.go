...
type SearchUserMetaOK struct {
	Payload *models2.RestUserMetaCollection
}
...
func (o *SearchUserMetaOK) Error() string {
	...
	return fmt.Sprintf("[POST /user-meta/search][%d] searchUserMetaOK %s", 200, payload)
}
...
func (o *SearchUserMetaOK) GetPayload() *models2.RestUserMetaCollection {
	return o.Payload
}
...
func (o *SearchUserMetaOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models2.RestUserMetaCollection)
...
func (o *SearchUserMetaUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /user-meta/search][%d] searchUserMetaUnauthorized %s", 401, payload)
}
...
func (o *SearchUserMetaUnauthorized) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *SearchUserMetaForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /user-meta/search][%d] searchUserMetaForbidden %s", 403, payload)
}
...
func (o *SearchUserMetaForbidden) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *SearchUserMetaNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /user-meta/search][%d] searchUserMetaNotFound %s", 404, payload)
}
...
func (o *SearchUserMetaNotFound) GetPayload() *models2.RestError {
	return o.Payload
}
...
func (o *SearchUserMetaInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /user-meta/search][%d] searchUserMetaInternalServerError %s", 500, payload)
}
...
func (o *SearchUserMetaInternalServerError) GetPayload() *models2.RestError {
	return o.Payload
}
