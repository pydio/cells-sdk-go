...
// Pointer returns a pointer to a freshly-allocated ListSharedResourcesRequestListShareType.
func (m ListSharedResourcesRequestListShareType) Pointer() *ListSharedResourcesRequestListShareType {
	return &m
}
