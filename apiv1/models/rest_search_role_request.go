...
// ContextValidate validate this rest search role request based on the context it is used
func (m *RestSearchRoleRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RestSearchRoleRequest) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestSearchRoleRequest) contextValidateQueries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestSearchRoleRequest) contextValidateResourcePolicyQuery(ctx context.Context, formats strfmt.Registry) error {
