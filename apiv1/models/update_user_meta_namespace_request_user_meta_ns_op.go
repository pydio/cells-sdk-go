...
// Pointer returns a pointer to a freshly-allocated UpdateUserMetaNamespaceRequestUserMetaNsOp.
func (m UpdateUserMetaNamespaceRequestUserMetaNsOp) Pointer() *UpdateUserMetaNamespaceRequestUserMetaNsOp {
	return &m
}
