...
// ContextValidate validate this idm update user meta request based on the context it is used
func (m *IdmUpdateUserMetaRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IdmUpdateUserMetaRequest) contextValidateMetaDatas(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IdmUpdateUserMetaRequest) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
