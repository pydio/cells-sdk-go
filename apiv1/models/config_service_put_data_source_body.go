...
// ConfigServicePutDataSourceBody DataSource Object description
//
// swagger:model ConfigServicePutDataSourceBody
type ConfigServicePutDataSourceBody struct {
...
// Validate validates this config service put data source body
func (m *ConfigServicePutDataSourceBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigServicePutDataSourceBody) validateEncryptionMode(formats strfmt.Registry) error {
...
func (m *ConfigServicePutDataSourceBody) validateStorageType(formats strfmt.Registry) error {
...
// ContextValidate validate this config service put data source body based on the context it is used
func (m *ConfigServicePutDataSourceBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigServicePutDataSourceBody) contextValidateEncryptionMode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigServicePutDataSourceBody) contextValidateStorageType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigServicePutDataSourceBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ConfigServicePutDataSourceBody) UnmarshalBinary(b []byte) error {
	var res ConfigServicePutDataSourceBody
