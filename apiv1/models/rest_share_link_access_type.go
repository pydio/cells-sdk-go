...
func NewRestShareLinkAccessType(value RestShareLinkAccessType) *RestShareLinkAccessType {
	return &value
}

// Pointer returns a pointer to a freshly-allocated RestShareLinkAccessType.
func (m RestShareLinkAccessType) Pointer() *RestShareLinkAccessType {
	return &m
}
...
func (m RestShareLinkAccessType) validateRestShareLinkAccessTypeEnum(path, location string, value RestShareLinkAccessType) error {
	if err := validate.EnumCase(path, location, value, restShareLinkAccessTypeEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this rest share link access type based on context it is used
func (m RestShareLinkAccessType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
