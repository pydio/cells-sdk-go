...
// RoleServiceSetRoleBody Role represents a generic set of permissions that can be applied to any users or groups.
//
// swagger:model RoleServiceSetRoleBody
type RoleServiceSetRoleBody struct {
...
// Validate validates this role service set role body
func (m *RoleServiceSetRoleBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RoleServiceSetRoleBody) validatePolicies(formats strfmt.Registry) error {
...
// ContextValidate validate this role service set role body based on the context it is used
func (m *RoleServiceSetRoleBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RoleServiceSetRoleBody) contextValidatePolicies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RoleServiceSetRoleBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RoleServiceSetRoleBody) UnmarshalBinary(b []byte) error {
	var res RoleServiceSetRoleBody
