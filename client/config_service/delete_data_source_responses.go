...
func (o *DeleteDataSourceUnauthorized) String() string {
	return fmt.Sprintf("[DELETE /config/datasource/{Name}][%d] deleteDataSourceUnauthorized ", 401)
}
...
func (o *DeleteDataSourceInternalServerError) IsSuccess() bool {
	return false
}
...
func (o *DeleteDataSourceInternalServerError) String() string {
	return fmt.Sprintf("[DELETE /config/datasource/{Name}][%d] deleteDataSourceInternalServerError  %+v", 500, o.Payload)
}
