...
// ContextValidate validate this rest meta collection based on the context it is used
func (m *RestMetaCollection) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RestMetaCollection) contextValidateMetadatas(ctx context.Context, formats strfmt.Registry) error {
